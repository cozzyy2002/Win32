...
template<class I>
HANDLE dispatch(I* listener, void (I::*method)(), DWORD delay = 0, bool interval = false)
{
	P0Dispatcher<I>* disp = new P0Dispatcher<I>(listener, method);
	return disp->dispatch(delay, interval);
}

template<class I, typename P1>
HANDLE dispatch(I* listener, void (I::*method)(const P1&), P1 p1, DWORD delay = 0, bool interval = false)
{
